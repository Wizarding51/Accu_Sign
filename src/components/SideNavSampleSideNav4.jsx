...
const SideNavSampleSideNav = ({ className = "" }) => {
  ...
  return (
    <div
      className={`h-[840px] w-[260px] flex flex-col items-start justify-start relative text-left text-sm text-gray-3 font-body mq850:hidden ${className}`}
    >
      ...
      />
      <div
        className="w-full h-[49px] !m-[0] absolute top-[0px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] cursor-pointer z-[2]"
      ...
      <div
        className="w-full h-[49px] !m-[0] absolute top-[147px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] cursor-pointer z-[2] text-active"
      ...
      <div
        className="w-full h-[49px] !m-[0] absolute top-[49px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] cursor-pointer z-[2]"
      ...
      <div className="w-full h-[49px] !m-[0] absolute top-[196px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] z-[2] text-active">
        <img
          className="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] max-w-full overflow-hidden max-h-full"
          alt=""
          src="/rectangle-1.svg"
      ...
      <div className="w-full h-[49px] !m-[0] absolute top-[245px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] z-[2] text-white">
        <img
          className="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] max-w-full overflow-hidden max-h-full"
          alt=""
          src="/rectangle.svg"
      ...
      <div
        className="w-full h-[49px] !m-[0] absolute top-[294px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] cursor-pointer z-[2] text-active"
