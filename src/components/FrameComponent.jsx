    ...
    >
      <div className="self-stretch flex flex-row items-center justify-between gap-[20px] mq450:flex-wrap">
        <div className="flex flex-col items-start justify-start gap-[9px] min-w-[61px] mq450:flex-1">
          ...
          <div className="relative text-16xl leading-[70px] font-black text-darkslategray-100 inline-block min-w-[61px] mq450:text-2xl mq450:leading-[42px] mq800:text-9xl mq800:leading-[56px]">
            {prop}
          </div>
        </div>
        <img
