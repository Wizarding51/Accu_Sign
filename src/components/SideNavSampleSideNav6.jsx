...
const SideNavSampleSideNav = ({ className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full h-[49px] !m-[0] absolute top-[49px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] cursor-pointer z-[2] text-gray-3"
      ...
      <div
        className="w-full h-[49px] !m-[0] absolute top-[98px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] cursor-pointer z-[2] text-gray-3"
      ...
      <div
        className="w-full h-[49px] !m-[0] absolute top-[343px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] cursor-pointer z-[2] text-white"
