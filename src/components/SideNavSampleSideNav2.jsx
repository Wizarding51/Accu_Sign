...
const SideNavSampleSideNav = ({ className = "" }) => {
  ...
  return (
    <div
      className={`h-[840px] w-[260px] flex flex-col items-start justify-start relative text-left text-sm text-active font-body mq1025:hidden ${className}`}
    >
      ...
      <div
        className="w-full h-[49px] !m-[0] absolute top-[147px] right-[0px] left-[0px] flex flex-col items-start justify-start pt-3 px-0 pb-[13px] box-border gap-[13px] cursor-pointer z-[2] text-white"
