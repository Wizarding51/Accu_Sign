...
const TripContractDetails = () => {
  return (
    <div className="self-stretch rounded bg-white flex flex-col items-start justify-start pt-[31px] px-[23px] pb-[66px] gap-[37px] text-center text-sm">
      <div className="w-[693px] flex flex-col items-start justify-start gap-[13px] max-w-full">
        <div className="w-[590px] flex flex-col items-start justify-start gap-[14px] max-w-full">
          <b className="relative leading-[24px] inline-block text-gray-1 text-left min-w-[83px]">
            Trip name 01
          </b>
        </div>
        <div className="self-stretch grid flex-row items-start justify-start gap-[15px] grid-cols-[repeat(3,_minmax(169px,_1fr))]">
      ...
      <div className="w-[693px] flex flex-col items-start justify-start gap-[23px] max-w-full text-left text-gray-1">
        <b className="relative leading-[24px] inline-block min-w-[83px]">
          Trip name 02
        </b>
        <div className="self-stretch grid flex-row items-start justify-start gap-[15px] grid-cols-[repeat(3,_minmax(169px,_1fr))] text-smi">
        <div className="w-[693px] grid flex-col items-start justify-start gap-[15px] max-w-[217px] text-left text-smi mq450:grid-cols-[minmax(169px,_1fr)] mq675:justify-center mq675:grid-cols-[repeat(2,_minmax(169px,_292px))]">
        <div className="h-[236px] flex flex-row items-start justify-start py-0 pr-1.5 pl-0 box-border">
          <div className="self-stretch flex-1 bg-gray-6 flex flex-col items-start justify-start pt-[7px] px-[5px] pb-2.5 gap-[8px] z-[1]">
            <div className="w-[219px] h-[236px] relative bg-gray-6 hidden" />
          ...
          <GroupComponent header4="APPENDIX 1" />
          <div className="bg-gray-6 flex flex-col items-start justify-start pt-[7px] px-1 pb-2.5 gap-[8px]">
            <div className="w-[219px] h-[236px] relative bg-gray-6 hidden" />
            <div className="self-stretch flex flex-row items-start justify-start relative">
              <img
                className="h-full w-full absolute top-0 right-0 bottom-0 left-0 max-w-full overflow-hidden max-h-full object-cover"
                alt=""
                src="/group-20.svg"
              />
            <GroupComponent header4="3 Year contract" />
      ...
      <div className="w-[693px] flex flex-col items-start justify-start gap-[23px] max-w-full">
        <b className="relative leading-[24px] inline-block text-gray-1 text-left min-w-[83px]">
          Trip name 03
        </b>
        <div className="self-stretch grid flex-row items-start justify-start gap-[15px] grid-cols-[repeat(3,_minmax(169px,_1fr))] text-smi">
...
export default TripContractDetails;
