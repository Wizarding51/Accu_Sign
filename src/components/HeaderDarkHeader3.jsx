...
const HeaderDarkHeader = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch h-[60px] relative bg-white overflow-hidden shrink-0 max-w-full ${className}`}
    >
      <header className="absolute top-[0px] left-[74px] w-[1366px] flex flex-row items-start justify-between gap-[20px] max-w-full text-left text-7xl text-gray-2 font-sacramento">
      ...
      <div className="absolute top-[0px] left-[0px] bg-white w-[260px] flex flex-row items-center justify-start">
        <img
